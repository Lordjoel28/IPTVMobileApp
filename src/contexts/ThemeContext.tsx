...
import { Theme, darkTheme, lightTheme, getThemeById, availableThemes } from '../themes/themeConfig';
...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({ children }) => {
  ...
  useEffect(() => {
    if (isSystemTheme) {
      ...
      console.log('🎨 [ThemeProvider] Thème système appliqué:', systemTheme.name);
    }
  ...
  const loadThemePreferences = async () => {
    try {
      ...
      if (shouldUseSystem) {
        ...
        const systemTheme = systemColorScheme === 'dark' ? darkTheme : lightTheme;
        setCurrentTheme(systemTheme);
        console.log('🎨 [ThemeProvider] Chargement thème système:', systemTheme.name);
      } else {
        ...
        if (savedThemeId) {
          ...
          console.log('🎨 [ThemeProvider] Chargement thème personnalisé:', theme.name);
        } else {
  ...
  const resetToSystem = async () => {
    try {
      ...
      console.log('🎨 [ThemeProvider] Retour au thème système:', systemTheme.name);
    } catch (error) {
